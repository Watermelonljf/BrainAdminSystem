	                ...
	                if (result.code == 1) {
	                 ...
	                 //   alert(new Date(data[1].sendTime.time).toLocaleDateString());
	                    for (var i = 0; i < data.length; i++) {
	                        ...
	                        html += '<td class="hidden-480">' +data[i].ccount+ '</td>';
	                        html += '<td class="hidden-480">' +data[i].cscount+ '</td>';  
	                         html += '<td class="hidden-480">' +data[i].cdep+ '</td>';
