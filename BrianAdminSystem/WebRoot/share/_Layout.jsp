                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="./Images/Head.png"  style="width:28px;"/>
                      		<span id="user-name">${loginuser.uname}</span>                    
            ...
            <ul id="menuall" class="page-sidebar-menu">
                ...
                <li id="menupage6">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li id="menupage6_0">
                            <a href="CommunicationView/Message.jsp?active=menupage6_0">商品管理</a>
                        </li>
                        <li id="menupage6_5">
                            <a href="Infojsp/AddGoods.jsp?active=menupage6_5">添加商品</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-menu">
                        <li id="menupage5_2">
                            <a href="UserEdite/UserList.jsp?active=menupage5_2">用户列表</a>
                        </li>
                        <li id="menupage5_1">
                            <a href="">用户</a>
                        </li>
                         <li id="menupage5_0">
                            <a href="UserEdite/UserInfo.jsp?active=menupage5_0">信息完善</a>
                        </li>
                        <!-- <li id="menupage5_1">
                 ...
                 <li id="menupage4">
                    ...
                    <ul class="sub-menu">
                        <li id="menupage4_2">
                            <a href="CompanyView/Publish.jsp?active=menupage4_2">订单列表</a>
                        </li>
                        <li id="menupage4_0">
                            <a href="CompanyView/Publish.jsp?active=menupage4_0">订单公告</a>
                        </li>
                      <!--    <li id="menupage4_1">
   ...
   <script>
        ...
        function passwordSave() {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                data: { "txtOldPassword": txtOldPassword, "txtNewPassword": txtNewPassword },
                success: function (data) {
                	alert(data.code);
                    if (data.code == 1) {
                        $("#passwordMessage").text("修改密码成功！");
                        window.setTimeout("location.href='User/LoginOut'", 3000);
                    }
                    else if(data.code==0){
                        $("#passwordMessage").text("旧密码错误,修改失败！");
                    }
                   /*  else{
