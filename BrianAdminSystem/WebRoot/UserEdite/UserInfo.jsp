...
I am title
 ...
 <link rel="stylesheet" href="Content/bootstrap/select2_metro.css" type="text/css"></link>
 <link rel="stylesheet" href="Content/bootstrap/chosen.css" type="text/css"></link>
						...
						<div class="portlet box yellow" id="form_wizard_1">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									...
									<i class="icon-reorder"></i> 用户信息完善 <span class="step-title">步骤1到4</span>
...
<Layout:overwrite name="MyScript">
	<script type="text/javascript" src="Scripts/bootstrap/form-wizard.js"></script>
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script type="text/javascript" src="Scripts/bootstrap/select2.min.js"></script>
<script type="text/javascript" src="Scripts/bootstrap/chosen.jquery.min.js"></script>
<script type="text/javascript" src="Scripts/bootstrap/jquery.bootstrap.wizard.min.js"></script>
<script type="text/javascript" src="Scripts/bootstrap/additional-methods.min.js"></script>
